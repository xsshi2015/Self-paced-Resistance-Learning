...
def pre_train(dataloader, test_loader, dataloader_test, true_label, noisy_rate, checkpoint_filename, total_epochs = 100, learning_rate=1e-5, use_gpu=True, arch = 'resnet_', seed=123):
    ...
    io.savemat('cifar10_pair_ResNet_epoch_test_accuracy'+'_'+ str(noisy_rate)+'.mat', mdict={'test_accuracy': epoch_test_accuracy})
...
def main():
    ...
    for iter in range(1):
        ...
        pre_train(train_loader, test_loader, train_loader_test, true_label, rate[iter], checkpoint_filename, total_epochs = 200, learning_rate=1e-4, use_gpu=True, arch='resnet_', seed=args.seed)
