...
#from model.resnet import ResNet101 as ResNet
...
def train(model, optimizer,dataloader, test_loader, dataloader_test, true_label, noisy_rate):
    ...
    gamma_d = 10
    gamma = 10
    b_epoch=20   # it is T1 in the paper
    ...
    io.savemat('cifar10_symmetric_ResNet101_epoch_test_accuracy'+'_'+ str(noisy_rate)+'.mat', mdict={'test_accuracy': epoch_test_accuracy})
