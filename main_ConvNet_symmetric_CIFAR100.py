...
def main():
    ...
    for iter in range(rate.size):
        ...
        pre_train(train_loader, test_loader, train_loader_test, true_label, rate[iter], checkpoint_filename, total_epochs = 200, learning_rate=1e-3, use_gpu=True, arch=arch, seed=args.seed)
